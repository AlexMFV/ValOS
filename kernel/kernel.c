...
void main() {
    ...
    vga[offset_from_vga+2] = 'l'; /* White text on black background */
    vga[offset_from_vga+3] = 0x04; /* White text on black background */
    vga[offset_from_vga+4] = 'e'; /* White text on black background */
    vga[offset_from_vga+5] = 0x0e; /* White text on black background */
    vga[offset_from_vga+6] = 'x'; /* White text on black background */
    vga[offset_from_vga+7] = 0x01; /* White text on black background */
}